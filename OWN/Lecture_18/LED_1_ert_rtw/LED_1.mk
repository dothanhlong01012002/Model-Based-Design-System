###########################################################################
## Makefile generated for component 'LED_1'. 
## 
## Makefile     : LED_1.mk
## Generated on : Wed Dec 20 09:48:18 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LED_1.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LED_1.elf
...
DEFINES_STANDARD = -DMODEL=LED_1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o LED_1.o LED_1_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/LED_1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/LED_1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
LED_1.o : $(START_DIR)/LED_1_ert_rtw/LED_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LED_1_data.o : $(START_DIR)/LED_1_ert_rtw/LED_1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/LED_1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
