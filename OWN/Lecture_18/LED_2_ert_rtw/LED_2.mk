###########################################################################
## Makefile generated for component 'LED_2'. 
## 
## Makefile     : LED_2.mk
## Generated on : Tue Dec 19 22:00:04 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LED_2.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LED_2.elf
...
DEFINES_STANDARD = -DMODEL=LED_2 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o LED_2.o LED_2_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/LED_2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/LED_2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
LED_2.o : $(START_DIR)/LED_2_ert_rtw/LED_2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LED_2_data.o : $(START_DIR)/LED_2_ert_rtw/LED_2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/LED_2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
