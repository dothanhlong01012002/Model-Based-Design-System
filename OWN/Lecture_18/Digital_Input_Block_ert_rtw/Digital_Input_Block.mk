###########################################################################
## Makefile generated for component 'Digital_Input_Block'. 
## 
## Makefile     : Digital_Input_Block.mk
## Generated on : Wed Dec 20 13:32:58 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Digital_Input_Block.elf
...
PRODUCT_NAME              = Digital_Input_Block
MAKEFILE                  = Digital_Input_Block.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Digital_Input_Block.elf
...
DEFINES_STANDARD = -DMODEL=Digital_Input_Block -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinobase/src/MW_arduino_digitalio.cpp $(START_DIR)/Digital_Input_Block_ert_rtw/Digital_Input_Block.c $(START_DIR)/Digital_Input_Block_ert_rtw/Digital_Input_Block_data.c $(START_DIR)/Digital_Input_Block_ert_rtw/rt_zcfcn.c C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp

MAIN_SRC = $(START_DIR)/Digital_Input_Block_ert_rtw/ert_main.c
...
OBJS = MW_arduino_digitalio.o Digital_Input_Block.o Digital_Input_Block_data.o rt_zcfcn.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Digital_Input_Block_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Digital_Input_Block_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Digital_Input_Block_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Digital_Input_Block.o : $(START_DIR)/Digital_Input_Block_ert_rtw/Digital_Input_Block.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Digital_Input_Block_data.o : $(START_DIR)/Digital_Input_Block_ert_rtw/Digital_Input_Block_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Digital_Input_Block_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_zcfcn.o : $(START_DIR)/Digital_Input_Block_ert_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
