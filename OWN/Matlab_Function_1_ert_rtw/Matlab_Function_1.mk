###########################################################################
## Makefile generated for component 'Matlab_Function_1'. 
## 
## Makefile     : Matlab_Function_1.mk
## Generated on : Wed Dec 20 20:42:45 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Matlab_Function_1.elf
...
PRODUCT_NAME              = Matlab_Function_1
MAKEFILE                  = Matlab_Function_1.mk
MATLAB_ROOT               = C:/PROGRA~1/POLYSP~1/R2021a
MATLAB_BIN                = C:/PROGRA~1/POLYSP~1/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/DO_AN/tai_lieu/Introduction_to_Model_Based_System_Design/Introduction_to_Model_Based_System_Design/OWN
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Matlab_Function_1.elf
...
DEFINES_STANDARD = -DMODEL=Matlab_Function_1 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o Matlab_Function_1.o Matlab_Function_1_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Matlab_Function_1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Matlab_Function_1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Matlab_Function_1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Matlab_Function_1.o : $(START_DIR)/Matlab_Function_1_ert_rtw/Matlab_Function_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Matlab_Function_1_data.o : $(START_DIR)/Matlab_Function_1_ert_rtw/Matlab_Function_1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Matlab_Function_1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
