 ...
 *
 * hilite_system('Lecture17__Model1/Controller  ')    - opens subsystem Lecture17__Model1/Controller
 * hilite_system('Lecture17__Model1/Controller  /Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'Lecture17__Model1'
 * '<S1>'   : 'Lecture17__Model1/Controller  '
 */
